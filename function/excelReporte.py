            ...
            dataInfo.append(
                {
                    ...
                    "id_lider_peloton": await SelectLiderPeloton(
                    ...
                    "nombre_gerente_regional": await SelectGerenteRegional(
                        i.id_gerente_regional
                    ),
                    "id_gerente_ciudad": i.id_gerente_ciudad,
                    "nombre_gerente_ciudad": await SelectGerenteCiudad(
                        i.id_gerente_ciudad
                    ),
                    "id_jefe_venta": i.id_jefe_venta,
                    "nombre_jefe_venta": await SelectJefeVenta(i.id_jefe_venta),
                    "nombre_admin_proyectos": await SelectAdminProyectCiudad(
                        i.id_ciudad
                    ),

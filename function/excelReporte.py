...
async def get_tdd_excel_workbook(ciudad: list, usuario: str): 
    try:
        ...
        ws.append([
            "CIUDAD","ESTADO","COD. VENDEDOR","VENDEDOR","LIDER DE PELOTON", "ADMINISTRADOR PROYECTO", "JEFE DE VENTA", "JEFE COMERCIAL", "GERENTE COMERCIAL", "CANAL DE VENTA","OPERADOR","SISTEMA OPERATIVO","GENERO","MODALIDAD","FECHA INGRESO","FECHA SALIDA","SECTOR RESIDENCIA","EMAIL","DIAS INACTIVO","CELULAR",

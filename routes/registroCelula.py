...
@registro.get("/reporte_list", tags=["Vendedor"])
async def get_reporList(request: Request):
    try:
        nombre_lider = RegistrarVendedor.select().where(RegistrarVendedor.c.id_lider_peloton == 341)
